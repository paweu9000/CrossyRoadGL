...
void Entity::update(float deltaTime)
{
    ...
    case Direction::NORTH:
        model = glm::rotate(glm::mat4(1.f), movement, glm::vec3(-1.0f, 0.0f, 0.0f)) * model;
    ...
    case Direction::SOUTH:
        ...
        break;
    case Direction::EAST:
        model = glm::rotate(glm::mat4(1.f), movement, glm::vec3(0.0f, 1.0f, 0.0f)) * model;
        view = glm::translate(glm::mat4(1.f), glm::vec3(movement, 0.f, 0.f)) * view;
        break;
    case Direction::WEST:
        model = glm::rotate(glm::mat4(1.f), movement, glm::vec3(0.0f, -1.0f, 0.f)) * model;
        view = glm::translate(glm::mat4(1.f), glm::vec3(-movement, 0.f, 0.f)) * view;
        break;
    default:
        break;
